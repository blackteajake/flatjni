...
public final class HelloReply extends Table {
  ...
  public String greeting() { int o = __offset(4); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer greetingAsByteBuffer() { return __vector_as_bytebuffer(4, 1); }

  public static int createHelloReply(FlatBufferBuilder builder,
      int greetingOffset) {
    builder.startObject(1);
    HelloReply.addGreeting(builder, greetingOffset);
  ...
  public static void addGreeting(FlatBufferBuilder builder, int greetingOffset) { builder.addOffset(0, greetingOffset, 0); }
