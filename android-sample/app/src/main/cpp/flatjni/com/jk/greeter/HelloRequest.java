...
public final class HelloRequest extends Table {
  ...
  public static int createHelloRequest(FlatBufferBuilder builder,
    ...
    HelloRequest.addPrice(builder, price);
    HelloRequest.addTotal(builder, total);
    HelloRequest.addDistance(builder, distance);
    HelloRequest.addName(builder, nameOffset);
    HelloRequest.addCount(builder, count);
    HelloRequest.addIsOK(builder, isOK);
    return HelloRequest.endHelloRequest(builder);
  }

  public static void startHelloRequest(FlatBufferBuilder builder) { builder.startObject(6); }
